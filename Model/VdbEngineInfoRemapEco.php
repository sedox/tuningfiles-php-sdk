...
/**
 * VdbEngineInfoRemapEco Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VdbEngineInfoRemapEco implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'vdb_engine_info_remap_eco';
...
'full_eco_perc' => null    ];
    ...
    protected static $attributeMap = [
        'combi_eco_perc' => 'combi_eco_perc',
'full_eco_perc' => 'full_eco_perc'    ];
    ...
    protected static $setters = [
        'combi_eco_perc' => 'setCombiEcoPerc',
'full_eco_perc' => 'setFullEcoPerc'    ];
    ...
    protected static $getters = [
        'combi_eco_perc' => 'getCombiEcoPerc',
'full_eco_perc' => 'getFullEcoPerc'    ];
    ...
    {
        $this->container['combi_eco_perc'] = isset($data['combi_eco_perc']) ? $data['combi_eco_perc'] : null;
        $this->container['full_eco_perc'] = isset($data['full_eco_perc']) ? $data['full_eco_perc'] : null;
    }
     ...
     * @return int
     */
    public function getCombiEcoPerc()
    {
        return $this->container['combi_eco_perc'];
    }

    /**
     * Sets combi_eco_perc
     *
     * @param int $combi_eco_perc Fuel savings. Combi ECO/Power (percentage).
     *
     * @return $this
     */
    public function setCombiEcoPerc($combi_eco_perc)
    {
        $this->container['combi_eco_perc'] = $combi_eco_perc;
     ...
     * @return int
     */
    public function getFullEcoPerc()
    {
        return $this->container['full_eco_perc'];
    }

    /**
     * Sets full_eco_perc
     *
     * @param int $full_eco_perc Fuel savings. Full ECO (percentage).
     *
     * @return $this
     */
    public function setFullEcoPerc($full_eco_perc)
    {
        $this->container['full_eco_perc'] = $full_eco_perc;
