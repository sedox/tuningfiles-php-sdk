...
'updated' => 'getUpdated'    ];
    ...
    const VEHICLE_TYPE_ID__1 = '1';
const VEHICLE_TYPE_ID__2 = '2';
const VEHICLE_TYPE_ID__3 = '3';
const VEHICLE_TYPE_ID__4 = '4';
const VEHICLE_TYPE_ID__5 = '5';
    ...
    {
        return [
            self::VEHICLE_TYPE_ID__1,
self::VEHICLE_TYPE_ID__2,
self::VEHICLE_TYPE_ID__3,
self::VEHICLE_TYPE_ID__4,
self::VEHICLE_TYPE_ID__5,        ];
    }
     ...
     *
     * @param BigDecimal $vehicle_type_id ID of the vehicle type. 1 - Cars & LCV, 2 - Trucks & Buses, 3 - Agriculture, 4 - Marine, 5 - Motorcycles & ATVs
     *
     * @return $this
     */
