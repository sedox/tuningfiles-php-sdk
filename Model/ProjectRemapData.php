...
class ProjectRemapData implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'remap' => 'string',
'remap_id' => 'int',
'addons' => '\Tuningfiles\Model\ProjectRemapDataAddons[]'    ];
...
'addons' => 'getAddons'    ];
     ...
     * Gets addons
     *
     * @return \Tuningfiles\Model\ProjectRemapDataAddons[]
     */
     ...
     * Sets addons
     *
     * @param \Tuningfiles\Model\ProjectRemapDataAddons[] $addons Array with all special requests (addons), requested by customer.
     *
     * @return $this
     */
