...
'customer_comment' => 'getCustomerComment'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vehicle_model_id'] === null) {
            $invalidProperties[] = "'vehicle_model_id' can't be null";
        }
        if ($this->container['vehicle_generation_id'] === null) {
            $invalidProperties[] = "'vehicle_generation_id' can't be null";
        }
     ...
     *
     * @param int $vehicle_model_id ID of the vehicle model. Obtained from the [/vehicles/models](#operation/vehicles_models_list) method.
     *
     * @return $this
     */
     ...
     *
     * @param int $vehicle_generation_id ID of the model generation. Obtained from the [/vehicles/generations](#operation/vehicles_generations_list) method.
     *
     * @return $this
     */
