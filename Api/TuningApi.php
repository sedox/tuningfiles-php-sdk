...
class TuningApi
{
     ...
     * @throws \Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tuningfiles\Model\DownloadJson
     */
     ...
     * @throws \Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tuningfiles\Model\DownloadJson, HTTP status code, HTTP response headers (array of strings)
     */
    public function fileDownloadWithHttpInfo($file_id, $project_id, $json = null)
    {
        $returnType = '\Tuningfiles\Model\DownloadJson';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tuningfiles\Model\DownloadJson',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function projectsCreate($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment)
    {
        list($response) = $this->projectsCreateWithHttpInfo($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment);
        return $response;
    }
     ...
     */
    public function projectsCreateWithHttpInfo($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment)
    {
        $returnType = '\Tuningfiles\Model\Projects';
        $request = $this->projectsCreateRequest($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsCreateAsync($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment)
    {
        return $this->projectsCreateAsyncWithHttpInfo($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsCreateAsyncWithHttpInfo($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment)
    {
        $returnType = '\Tuningfiles\Model\Projects';
        $request = $this->projectsCreateRequest($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function projectsCreateRequest($ecu1_file, $ecu1_label, $ecu2_file, $ecu2_label, $vehicle_type_id, $vehicle_manufacturer_id, $vehicle_model_id, $vehicle_engine, $vehicle_engine_id, $vehicle_year, $vehicle_gearbox, $vehicle_ecu, $hardware_number, $software_number, $read_tool, $remap, $addons, $dtc_codes, $notification_channel, $file_attachment, $ref, $customer_comment)
    {
     ...
     * List projects
     *
     * @param  BigDecimal $per_page Projects per page (optional)
     ...
     * @return \Tuningfiles\Model\Projects
     */
    public function projectsList($per_page = null, $page = null)
    {
     ...
     * @return array of \Tuningfiles\Model\Projects, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectsListWithHttpInfo($per_page = null, $page = null)
    {
        $returnType = '\Tuningfiles\Model\Projects';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsListAsync($per_page = null, $page = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsListAsyncWithHttpInfo($per_page = null, $page = null)
    {
        $returnType = '\Tuningfiles\Model\Projects';
        $request = $this->projectsListRequest($per_page, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function projectsListRequest($per_page = null, $page = null)
    {
     ...
     *
     * @param  BigDecimal $vehicle_type_id Vehicle type (required)
     *
     * @throws \Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tuningfiles\Model\VehicleRemaps
     */
     ...
     * @throws \Tuningfiles\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tuningfiles\Model\VehicleRemaps, HTTP status code, HTTP response headers (array of strings)
     */
    public function remapsListWithHttpInfo($vehicle_type_id)
    {
        $returnType = '\Tuningfiles\Model\VehicleRemaps';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tuningfiles\Model\VehicleRemaps',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function vehiclesEnginesList($model_id)
    {
        list($response) = $this->vehiclesEnginesListWithHttpInfo($model_id);
        return $response;
    }
     ...
     */
    public function vehiclesEnginesListWithHttpInfo($model_id)
    {
        $returnType = '\Tuningfiles\Model\VehicleEngine[]';
        $request = $this->vehiclesEnginesListRequest($model_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function vehiclesEnginesListAsync($model_id)
    {
        return $this->vehiclesEnginesListAsyncWithHttpInfo($model_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function vehiclesEnginesListAsyncWithHttpInfo($model_id)
    {
        $returnType = '\Tuningfiles\Model\VehicleEngine[]';
        $request = $this->vehiclesEnginesListRequest($model_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function vehiclesEnginesListRequest($model_id)
    {
        // verify the required parameter 'model_id' is set
        if ($model_id === null || (is_array($model_id) && count($model_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $model_id when calling vehiclesEnginesList'
            );
        }

        $resourcePath = '/vehicles/engines/{model_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
